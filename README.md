...
For Spark 3.X:
```sbt
libraryDependencies += "io.dataflint" %% "spark" % "0.9.6"
```

For Spark 4.X:
```sbt
libraryDependencies += "io.dataflint" %% "dataflint-spark4" % "0.9.6"
```
...
builder = pyspark.sql.SparkSession.builder
    ...
    .config("spark.jars.packages", "io.dataflint:spark_2.12:0.9.6") \
    .config("spark.plugins", "io.dataflint.spark.SparkDataflintPlugin") \
    ...
```
...
builder = pyspark.sql.SparkSession.builder
    ...
    .config("spark.jars.packages", "io.dataflint:dataflint-spark4_2.13:0.9.6") \
    .config("spark.plugins", "io.dataflint.spark.SparkDataflintPlugin") \
    ...
```
...
```bash
spark-submit
--packages io.dataflint:spark_2.12:0.9.6 \
...
```bash
spark-submit
--packages io.dataflint:dataflint-spark4_2.13:0.9.6 \
--conf spark.plugins=io.dataflint.spark.SparkDataflintPlugin \
...
```
