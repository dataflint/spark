...
```sbt
libraryDependencies += "io.dataflint" %% "spark" % "0.2.8"
```
...
```bash
spark-submit
--packages io.dataflint:spark_2.12:0.2.8 \
...
* There is also support for scala 2.13, if your spark cluster is using scala 2.13 change package name to io.dataflint:spark_**2.13**:0.2.8
