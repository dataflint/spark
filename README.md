...
```sbt
libraryDependencies += "io.dataflint" %% "spark" % "0.2.7"
```
...
* There is also support for scala 2.13, if your spark cluster is using scala 2.13 change package name to io.dataflint:spark_**2.13**:0.2.7
