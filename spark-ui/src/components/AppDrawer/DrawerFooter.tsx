...
export default function DrawerFooter({ appBasePath, version }: { appBasePath:string, version?: string }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" , margin: "5px", alignItems: "center", fontSize:"12px"}}>
      <Button onClick={onSparkUiClick} color="inherit" >To Spark UI</Button>
      {`Version ${version}`}
    </div>
  );
}