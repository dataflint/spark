...
describe("parseFileScan", () => {
  const testCases = [
    {
      input:
        "FileScan parquet spark_catalog.tpcds.web_sales[...] Format: Parquet, Location: InMemoryFileIndex(1823 paths)[file:/Users/menishmueli/Documents/GitHub/spark-sql-perf/data/web_sales/ws_sold_date_sk=2451895, ...], PartitionFilters: [isnotnull(ws_sold_date_sk#1274), dynamicpruningexpression(ws_sold_date_sk#1274 IN dynamicpruning#25981)], PushedFilters: [IsNotNull(ws_web_site_sk)], ReadSchema: struct<ws_web_site_sk:int,ws_ext_sales_price:decimal(7,2),ws_net_profit:decimal(7,2)>",
      nodeName: "Scan Text",
      expected: {
        format: "Parquet",
        Location:
          "file:/Users/menishmueli/Documents/GitHub/spark-sql-perf/data/web_sales/ws_sold_date_sk=2451895",
        PartitionFilters: [
          "isnotnull(ws_sold_date_sk)",
          "dynamicpruningexpression(ws_sold_date_sk IN dynamicpruning)",
        ],
    ...
    {
      input:
        "FileScan parquet spark_catalog.tpcds.item[i_item_sk#896,...] Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/menishmueli/Documents/GitHub/spark-sql-perf/data/item], PartitionFilters: [], PushedFilters: [IsNotNull(i_manufact_id)], ReadSchema: struct<i_item_sk:int,i_brand_id:int,i_brand:string,i_manufact_id:int>",
      nodeName: "Scan Text",
      expected: {
        format: "Parquet",
        Location:
          "file:/Users/menishmueli/Documents/GitHub/spark-sql-perf/data/item",
        PartitionFilters: [],
