...
const nodeTypeDict: Record<string, NodeType> = {
  ...
  DataFlintMapInPandas: "transformation",
  MapInArrow: "transformation",
  PythonMapInArrow: "transformation",
  DataFlintPythonMapInArrow: "transformation",
  DataFlintMapInArrow: "transformation",
  ArrowEvalPython: "transformation",
  DataFlintArrowEvalPython: "transformation",
  FlatMapGroupsInPandas: "transformation",
  DataFlintFlatMapGroupsInPandas: "transformation",
  FlatMapCoGroupsInPandas: "transformation",
  DataFlintFlatMapCoGroupsInPandas: "transformation",
  BatchEvalPython: "transformation",
  DataFlintBatchEvalPython: "transformation",
...
const nodeRenamerDict: Record<string, string> = {
  ...
  MapInPandas: "Select (with Pandas UDF)",
  DataFlintMapInPandas: "Select (with Pandas UDF)",
  MapInArrow: "Select (with Arrow UDF)",
  PythonMapInArrow: "Select (with Arrow UDF)",
  DataFlintPythonMapInArrow: "Select (with Arrow UDF)",
  DataFlintMapInArrow: "Select (with Arrow UDF)",
  ArrowEvalPython: "Select (with Arrow UDF)",
  DataFlintArrowEvalPython: "Select (with Arrow UDF)",
  FlatMapGroupsInPandas: "Select Flat (with Pandas UDF)",
  DataFlintFlatMapGroupsInPandas: "Select Flat (with Pandas UDF)",
  FlatMapCoGroupsInPandas: "Join (with Pandas UDF)",
  DataFlintFlatMapCoGroupsInPandas: "Join (with Pandas UDF)",
  BatchEvalPython: "Python UDF",
  DataFlintBatchEvalPython: "Python UDF",
  Window: "Window",
