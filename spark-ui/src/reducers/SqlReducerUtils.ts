...
> = {
  ...
  "sort time": extractTotalFromStatisticsMetric,
  "agg time": extractTotalFromStatisticsMetric,
  "build time": extractTotalFromStatisticsMetric,
...
const nodeTypeDict: Record<string, NodeType> = {
  ...
  ArrowWindowPython: "transformation",
...
const nodeRenamerDict: Record<string, string> = {
  ...
  ArrowWindowPython: "Window (with Arrow UDF)",
  Expand: "Expand",
};
