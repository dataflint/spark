...
const nodeRenamerDict: Record<string, string> = {
  ...
  DataFlintMapInPandas: "Select (with Pandas)",
  MapInArrow: "Select (with Arrow)",
  PythonMapInArrow: "Select (with Arrow)",
  DataFlintMapInArrow: "Select (with Arrow)",
  ArrowEvalPython: "Select (with Arrow)",
  DataFlintArrowEvalPython: "Select (with Arrow)",
  FlatMapGroupsInPandas: "Select Flat (with Pandas)",
  DataFlintFlatMapGroupsInPandas: "Select Flat (with Pandas)",
  FlatMapCoGroupsInPandas: "Join (with Pandas)",
  DataFlintFlatMapCoGroupsInPandas: "Join (with Pandas)",
  BatchEvalPython: "Select (with Python UDF)",
  DataFlintBatchEvalPython: "Select (with Python UDF)",
  Window: "Window",
  WindowInPandas: "Window (with Pandas)",
  DataFlintWindow: "Window",
  DataFlintWindowInPandas: "Window (with Pandas)",
  DataFlintArrowWindowPython: "Window (with Arrow)",
  Expand: "Expand",
};
