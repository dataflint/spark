...
export function extractRunMetadata(name: string, appId: string, attempt: Attempt): RunMetadataStore {
...
export function extractConfig(sparkConfiguration: SparkConfiguration): [string, Record<string, string>] {
